            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-900 mb-2">Seçilen Oyunlar ({selectedGames.length})</h4>
                  <div className="space-y-2">
                    {selectedGames.map((userGame) => (
                      <div key={userGame.id} className="flex items-center text-blue-800">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start">
                  ...
                  <p>Müşteriler iframe'den oyunları görür</p>
                </div>
                <div className="flex items-start">
